...
const REGISTRY = {
  ...
  retirement: stub("retirement", ["decision_echo", "future_handoff", "memory_lens", "turning_point"]),
  loan: stub("loan", ["promise_weight", "released_future", "future_handoff", "shadow_guardian"]),
