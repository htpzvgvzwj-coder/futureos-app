...
const wedding = {
  ...
  constraints: ["min_core_guests", "latest_wedding_month", "minimum_guest_experience_spend", "emergency_floor_months", "max_monthly_contribution", "no_balance_share", "no_guardian_auto_move"],
  evidence: [
...
const STUDIO_CONTRACTS = {
  wedding: {
    ...
    nativeScene: "features/wedding/WeddingContinuousScene", // continuous Budget-River scene (causal-spine round)
    ...
    constraintKinds: ["min_core_guests", "latest_wedding_month", "minimum_guest_experience_spend", "emergency_floor_months", "max_monthly_contribution", "no_balance_share"],
    turningPointRules: "features/wedding/WeddingContinuousScene#weddingTurningPoint + api/wedding-thread#weddingTurningPoints (budget gap / behind pace)",
