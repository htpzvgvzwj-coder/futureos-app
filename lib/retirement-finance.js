...
// raInsteadOfSa flips true starting AT age 55 (SA closes ON the 55th
// birthday, when RA is created — a contribution earned during the age-55
// year cannot go into an already-closed SA). The age-55 band keeps the
// same percentage split as the 50-55 band, just redirected to RA; once RA
// savings hit the prevailing FRS, RA-directed contributions redirect to OA
// instead (modeled in simulateOneYear, not here).
const ALLOCATION_BANDS = [
  ...
  { maxAge: 54, oa: 0.15, saOrRa: 0.115, ma: 0.105, raInsteadOfSa: false },
  { maxAge: 55, oa: 0.15, saOrRa: 0.115, ma: 0.105, raInsteadOfSa: true },
