...
Customer's real financial profile: monthly income SGD ${profile.monthlyIncome}${profile.isIncomeIrregular ? ` (a ${profile.incomeSampleSize}-month smoothed median - income varies month to month, do not treat it as guaranteed stable)` : ""}, monthly expenses SGD ${profile.monthlyExpenses}, current savings SGD ${profile.currentSavings}.
