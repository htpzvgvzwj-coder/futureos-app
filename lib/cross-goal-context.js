...
export function computeLoanImpact(loans, extraMonthlyCommitment, { monthlyIncome, monthlyExpenses, currentSavings, committedMonthlyTotal }) {
...
export function computeInvestmentImpact(investments, extraMonthlyCommitment, { monthlyIncome, monthlyExpenses, currentSavings, committedMonthlyTotal }) {
  return investments
