...
const weddingAdapter = {
  ...
  // Real cross-goal projection for one branch vs the reality path. Home and
  // Emergency nodes on the field move by this.
  projectImpacts(branchData, realityData, context = {}) {
    ...
    return projectWeddingBranchImpact({ branchFinance, realityFinance, context });
  },
