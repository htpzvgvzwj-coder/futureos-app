...
const homeAdapter = {
  ...
  feasibility(planData) {
    ...
    return {
      ...
      ...fin,
      downPaymentNeeded,
      // Part 0.4: explicit sealability verdict - never left undefined.
      sealable: fin.within_affordability !== false,
      sealableReason: fin.within_affordability === false ? "over_affordability_limit" : "within_affordability",
