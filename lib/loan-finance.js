...
// since there's no down payment to draw savings down for.
function computeFutureScore({ monthlyInstallment, monthlyIncome, monthlyExpenses, currentSavings, extraCashUsed, otherGoalsMonthlyOutflow }) {
...
export function computeLoanArchetype(purposeKey, archetypeKey, params) {
  ...
  const annualRatePercent = purpose.baseRatePercent;
