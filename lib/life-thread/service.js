...
export async function buildLifeThread(userId) {
  ...
  const committedMonthlyTotal = Math.round(crossGoal.committedMonthlyTotal || 0);
  ...
  const activeDrafts = branchesByPlan.flatMap(({ plan, branches }) =>
    branches
      ...
      .map((b) => ({ domain: plan.domain, planId: plan.id, branchId: b.id, label: b.label, updatedAt: b.updated_at, delta: b.delta ?? {} })),
  );
  ...
  const lifeNodes = [
    ...
    nodeFor("home", { value: null, known: domainsCommitted.has("home") || domainsWithDraft.has("home"), moving: domainsWithDraft.has("home"), waiting: false }),
    nodeFor("relationships", { value: null, known: domainsCommitted.has("wedding") || domainsCommitted.has("family") || domainsWithDraft.has("wedding") || domainsWithDraft.has("family"), moving: domainsWithDraft.has("wedding") || domainsWithDraft.has("family"), waiting: false }),
    ...
    nodeFor("future", { value: null, known: domainsCommitted.has("retirement") || domainsWithDraft.has("retirement"), moving: domainsWithDraft.has("retirement"), waiting: false }),
  ];
  ...
  const material = {
    ...
    studioImpactTotals: studioImpacts.totals,
