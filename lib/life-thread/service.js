...
export async function buildLifeThread(userId) {
  ...
  const lifeNodes = [
    ...
    nodeFor("relationships", { value: null, horizon: nodeHorizon.relationships, known: nodeKnown("wedding", "family"), moving: domainsWithDraft.has("wedding") || domainsWithDraft.has("family"), waiting: false }),
