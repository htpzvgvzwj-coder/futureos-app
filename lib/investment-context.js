...
export async function getOtherGoalsMonthlyCommitment() {
...
export async function getRetirementGap() {
  const session = await retirementStore.getOrCreateSession(retirementStore.DEFAULT_PROFILE_KEY);
