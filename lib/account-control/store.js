...
const OWNED_TABLES = [
  ...
  "consent_records", "lifecycle_roles", "care_handoff_plans", "authorization_policies", "authorization_requests",
  "import_batches", "audit_events", "user_onboarding",
];
...
const DELETE_ORDER = [
  ...
  "plans", "consent_records", "care_handoff_plans", "authorization_requests", "authorization_policies", "lifecycle_roles",
];
