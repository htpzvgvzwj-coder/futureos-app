...
// uptime.
//
// Deliberately NOT used for the 12 multi-turn conversational routes
// (wedding/home/retirement/other's stage1/stage2, investment/stage1,
// loan/stage1, hardship/assess, hardship/propose-actions) - those already
// have a considered, working resilience strategy (a deterministic local
// mock per domain, see lib/{wedding,home,...}-mock.js), and giving them a
// second real-AI-provider fallback would also require translating
// Anthropic's tool_use/tool_result conversation history into each other
// provider's own multi-turn format - real, unsolved complexity this module
// does not attempt. Also not used by Mirror chat (lib/chat-tool-loop.js) -
// a genuine multi-iteration agentic loop with real server-executed tool
// results fed back mid-turn, a different problem again. Only used by
// single-shot routes with no conversation history to translate: Mirror
// debate, Decode This, and Quick Verdict's narration (decision/check).
