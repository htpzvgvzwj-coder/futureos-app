...
export async function saveDebate(profileKey, debate) {
  const result = await query(
    `insert into mirror_debates
       (profile_key, goal_type, situation, future_score, risk_level, bull_case, bear_case, bear_risk_tag, judge_synthesis, recommended_action, confidence, context, ai_provider)
