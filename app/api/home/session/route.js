import { DEFAULT_PROFILE_KEY, getLatestArtifact, getOrCreateSession } from "../../../../lib/home-store.js";
...
export async function GET() {
  ...
  const [planOptions, confirmedPlan, savingsPlanOptions, confirmedSavingsPlan] = await Promise.all([
    getLatestArtifact(session.id, "stage1", "plan_options"),
    getLatestArtifact(session.id, "stage1", "confirmed_plan"),
